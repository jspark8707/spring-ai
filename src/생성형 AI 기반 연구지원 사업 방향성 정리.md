...
※ Metadata는 별도 RDB를 의미하는 것이 아니라, AI 검색과 활용을 위한 메타데이터 관리체계를 의미한다.
...
과 같은 Metadata 체계를 어떻게 설계하고 관리할 것인가가 더 중요하다.

즉,

**"Vector DB 구축" 보다 "Metadata 기반 AI 지식체계 구축"이 본 사업의 핵심 설계 요소가 될 것으로 판단된다.**
